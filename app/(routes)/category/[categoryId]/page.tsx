...
type SearchParams = Promise<{ ageId: string, durationId: string, destinationId: string, sizeId: string }>
...
const CategoryPage = async ({ params, searchParams }: { params: Params, searchParams: SearchParams }) => {
    ...
    const products = await getProducts({ categoryId: categoryId, ageId: ageId, durationId: durationId, destinationId: destinationId, sizeId: sizeId })
            ...
            <Container>
                ...
                <div className="px-4 pb-24 sm:px-6 lg:px-8">
                    <div className="lg:grid lg:grid-cols-5 lg:gap-x-8">
                        ...
                        <MobileFilters sizes={sizes} ages={ages} durations={durations} destinations={destinations} />
